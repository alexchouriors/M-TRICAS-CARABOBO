...
const HistoryEngine = {
  ...
  /* ── Configuración ── */
  GITHUB_API: 'https://api.github.com/repos/alexchouriors/M-TRICAS-CARABOBO/contents/REPORTES',
...
const CloudEngine = {
  ...
  GITHUB_UPLOAD_BASE: 'https://api.github.com/repos/alexchouriors/M-TRICAS-CARABOBO/contents/REPORTES/',
...
const DbDefaultEngine = {
  ...
  GITHUB_CONTENTS_BASE: 'https://api.github.com/repos/alexchouriors/M-TRICAS-CARABOBO/contents/',
  VALID_EXTS: ['.xlsx', '.xlsm', '.xls'],
